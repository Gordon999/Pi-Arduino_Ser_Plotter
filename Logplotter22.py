...
class Plot(Frame):
    ...
    def initUI(self):
        ...
        self.in_date = DateEntry(Frame10, width=8, background='darkblue',foreground='white', borderwidth=2)
    ...
    def Plot(self):
        self.L4.config(text= "      ")
        dat = datetime.datetime.strptime(self.in_date.get(), '%m/%d/%y').strftime('%y-%m-%d')
